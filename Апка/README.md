# VolkovApp — микросервисный Task Manager

VolkovApp — учебный микросервисный проект для защиты в ВУЗе: управление проектами и задачами через веб‑интерфейс, авторизация и RBAC, ACL на уровне проекта (участники/роли), события через RabbitMQ, аудит и «уведомления» (логирование попыток доставки).
...
Подробное описание проекта и диаграммы:
- `docs/PROJECT.md`
